package com.girrafeecstud.beauty_app_api.feature_masters.domain.entity;
...
public class MasterEntity {
    ...
    public MasterEntity(String masterFirstName, String masterLastName, String masterProfileDescription) {
        this.masterFirstName = masterFirstName;
        this.masterLastName = masterLastName;
        this.masterProfileDescription = masterProfileDescription;
    }
